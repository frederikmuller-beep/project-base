...
var client_references_default = {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-CSmC21G7.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"718ba2e49928": async () => {
		const m = await import("./assets/export-panel-5T5uASSQ.js");
		return { get "ExportPanel"() {
			return m["ExportPanel"];
		} };
	},
	"8f7ba5393f33": async () => {
		const m = await import("./assets/error-boundary-DY1owgia.js");
		return {
			get "ErrorBoundary"() {
	...
	"ee6cb3d92c61": async () => {
		const m = await import("./assets/layout-segment-context-KNCV6w-p.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"f5bf00e61209": async () => {
		const m = await import("./assets/owner-dashboard-DUW9lpOm.js");
		return { get "OwnerDashboard"() {
			return m["OwnerDashboard"];
		} };
	},
	"f62636e9342d": async () => {
		const m = await import("./assets/coach-dashboard-DnzcoP28.js");
		return { get "CoachDashboard"() {
			return m["CoachDashboard"];
		} };
	}
};
//#endregion
