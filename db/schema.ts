...
export const testParticipants = sqliteTable("test_participants", {
  ...
  trainingProfile: text("training_profile", { enum: ["weightlifting", "long_distance", "middle_distance", "sprint", "recreational", "athletics", "golf", "running", "powerlifting", "bodybuilding", "skiing", "triathlon", "ironman", "hyrox", "crossfit", "cycling", "american_football", "football", "handball"] }),
...
export const trainingSetLogs = sqliteTable("training_set_logs", {
  ...
  techniqueQuality: text("technique_quality", { enum: ["good", "uncertain", "poor"] }),
