...
type AthleteSession = {
  ...
  sets: Array<{ exerciseName: string; setNumber: number; weight: string; reps: string; rpe: string; effortMetric?: "rpe" | "rir" | "heart_rate_zone"; techniqueQuality?: "good" | "uncertain" | "poor" | null }>;
};
