...
const longDistanceStrength: StrengthSession[] = [
  ...
  { title: "Ben & ryg", focus: "Udholdende kraft uden unødig træthed", duration: 60, intensity: "Moderat", exercises: [strength("Front squat", 4, "6", "55", 90, "Høj torso"), strength("Lat pulldown", 4, "10", "40", 60, "Træk med ryggen"), strength("Bulgarian split squat", 3, "8", "20", 60, "Jævn kontrol"), strength("Calf raise", 3, "12", "30", 45, "Fuld bevægelse"), strength("Plank", 3, "40 sek", "0", 30, "Stabil vejrtrækning")] },
